...
from Kartik.utils import AdminRightsCheck
from Kartik.utils.database import is_active_chat, is_nonadmin_chat
from Kartik.utils.decorators.language import languageCB
from Kartik.utils.inline import close_markup, speed_markup
...
async def del_back_playlist(client, CallbackQuery, _):
    ...
    try:
        await Kartikraj.speedup_stream(
            chat_id,
            file_path,
            speed,
            playing,
